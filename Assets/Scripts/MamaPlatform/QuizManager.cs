...
public class QuizManager : MonoBehaviour
{
   ...
   public int AddOrSubtractQuestion(){
        ...
        if (AddingOrSubtracting == 0){
            ...
            a = operand1 - operand2;
            TheQuestion.GetComponent<Text>().text = QuestionText;
            }
        }
        else{
    ...
    public void ForButtonOne(){
        if (AddingOrSubtracting == 0){
            ...
            ButtonOne.transform.GetChild(0).GetComponent<Text>().text = "Is it " + ButtonOneAnswer + " ?" ;
    ...
    public void ForButtonTwo(){
        if (AddingOrSubtracting == 0){
            ...
            ButtonTwo.transform.GetChild(0).GetComponent<Text>().text = "Is it " + a + "?";

        }
        else{
            
            ButtonTwo.transform.GetChild(0).GetComponent<Text>().text = "Is it " + b + "?";
    ...
    public void ForButtonThree(){
        if (AddingOrSubtracting == 0){
            ...
            ButtonThree.transform.GetChild(0).GetComponent<Text>().text = "Is it " + ButtonThreeAnswer + "?";
    ...
    public void ForButtonOneWrong(){
        ...
        WrongPanel.transform.GetChild(0).GetComponent<Text>().text = "WRONG";
    }
    public void ForButtonTwoCorrect(){
        CorrectPanel.SetActive(true);
        CorrectPanel.transform.GetChild(0).GetComponent<Text>().text = "CORRECT";
    }
